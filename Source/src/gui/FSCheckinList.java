 ...
 * @author ICHIGEKI
 */
public class FSCheckinList extends javax.swing.JFrame {

    /**
     * Creates new form FSCheckinList
     */
    public static FSCheckinList it;
    public FSCheckinList() {
        initComponents();
        it = this;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Check in list", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if(grlist.getRowCount()!=0){
            JOptionPane.showMessageDialog(this, "Please add all reception.");
            return;
        }else{
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        FSReceptionMenu temp = FSReceptionMenu.it;
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        if(grlist.getRowCount()!=s.length){
            if (JOptionPane.showConfirmDialog(null, "Are you sure to cancel.", "cancel Confirm", JOptionPane.YES_NO_OPTION) == 0) {
                new IReceptionImpl().deleteByReser(re.getReservationID());
                FSReceptionMenu.it.initData();
                this.dispose();
            }            
        }else{
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSCheckinList().setVisible(true);
            }
        });
    }
