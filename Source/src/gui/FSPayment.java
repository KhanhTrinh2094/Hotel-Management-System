 ...
 * @author ICHIGEKI
 */
public class FSPayment extends javax.swing.JFrame {

    /**
     * Creates new form FSPayment
     */
    Reception r;
    int index, amount;
    ...
    public FSPayment(Reception r, int index) {
        initComponents();
        this.r = r;
        this.index = index;
        initPay();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Payment", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ipi.insertTan(p)) {
            ...
            iri.updateTan(r);
            this.dispose();
            FSPaymentMenu.pm.model.setRowCount(0);
            FSPaymentMenu.pm.initModel();
            FSPaymentMenu.pm.sort();
        } else {
