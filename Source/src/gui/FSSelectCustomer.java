 ...
 * @author ICHIGEKI
 */
public class FSSelectCustomer extends javax.swing.JFrame {

    public int count, max, from;
    public String form;
    public static FSSelectCustomer it;

    /**
     * Creates new form FSSelectCustomer
     */
    public FSSelectCustomer() {
        initComponents();
        initData();
        it = this;
        count = 0;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Selecting Customers", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Customer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        FSAddCustomer fs = new FSAddCustomer();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (cus.trim().length() == 0 && id.trim().length() == 0) {
            JOptionPane.showMessageDialog(this, "Please enter at least one proviso.");
        ...
        if (id.trim().length() != 0) {
            if (!Pattern.compile("\\d{0,20}", Pattern.CASE_INSENSITIVE).matcher(id).matches()) {
                JOptionPane.showMessageDialog(null, "Government ID must be number and < 20!");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (count < max) {
            if (grCus.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please select a customer before add.");
                return;
            }
            for (int i = 0; i < grSelect.getRowCount(); i++) {
                if (grCus.getValueAt(grCus.getSelectedRow(), 1) == grSelect.getValueAt(i, 1)) {
                    JOptionPane.showMessageDialog(this, "Cannot add this customer.");
                    return;
                }
            }
            Vector v = new Vector();
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        if (grSelect.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Please select a customer before remove.");
            return;
        }
        Vector v = new Vector();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (grSelect.getRowCount() != 0) {
            if (form.equals("recep")) {
                if (from == 1) {
                    FSReceptionMenu.it.tempRecep.setCusGroupID((int) grSelect.getValueAt(0, 3));
                }
                if (from == 0) {
                    ...
                    FSReceptionMenu.it.tempRecep.setCustomer(s);
                }
            ...
            if (form.equals("reser")) {
                if (from == 1) {
                    FSReservationMenu.it.tempRe.setCustomerID((int) grSelect.getValueAt(0, 3));
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSSelectCustomer().setVisible(true);
            }
        });
    }
