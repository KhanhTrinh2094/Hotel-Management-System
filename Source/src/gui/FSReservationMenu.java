 ...
 * @author User
 */
public class FSReservationMenu extends javax.swing.JFrame {

    /**
     * Creates new form Reception
     */
    public static FSReservationMenu it;

    public FSReservationMenu() {
        initComponents();
        it = this;
        initModel();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/banner_Reservation.png"))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Search", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Reservation Form", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));

        jLabel2.setForeground(new java.awt.Color(51, 51, 255));
        jLabel2.setText("Expected Check in Date");

        jLabel3.setForeground(new java.awt.Color(51, 51, 255));
        jLabel3.setText("Customer");

        btnSelectRoom.setText("Room");
        ...
        jLabel8.setText("Expected Check out Date");
        ...
        grViewReservation.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer", "Expected check in", "Expected check out", "Room Type", "Is deposit", "reserID", "CMND"
            }
        ) {
        ...
        btnCheckin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/btncheckin.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 764, Short.MAX_VALUE)
        );
    ...
    private void btnSelectCusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectCusActionPerformed
        if (!btnSearch.isEnabled() && btnUpdate.isEnabled()) {
            if (grViewReservation.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please choose a reservation before select customer.");
                return;
            }
        }
        FSSelectCustomer sc = new FSSelectCustomer();
        sc.setFrom(1, "reser");
        sc.setMax(1);
    ...
    private void btnSelectRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectRoomActionPerformed
        if (!btnSearch.isEnabled() && btnUpdate.isEnabled()) {
            if (grViewReservation.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please choose a reservation before select room.");
                return;
            }
        }
        FSSelectRoom sr = new FSSelectRoom();
        sr.setFrom(0, "reser");
        sr.setMax(20);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (btnStt) {
            ...
            if (dcsExpectedCheckIn.getDate() == null) {
                JOptionPane.showMessageDialog(this, "Please choose a valid checkin date");
                dcsExpectedCheckIn.setDate(null);
                return;
            }
            if (dcsExpectedCheckOut.getDate() == null) {
                JOptionPane.showMessageDialog(this, "Please choose a valid checkout date");
                dcsExpectedCheckOut.setDate(null);
                return;
            }
            if (dcsExpectedCheckIn.getDate().before(new Date())) {
                JOptionPane.showMessageDialog(this, "Checkin date must after today.");
                dcsExpectedCheckIn.setDate(new Date());
                return;
            }
            if (dcsExpectedCheckIn.getDate().after(dcsExpectedCheckOut.getDate())) {
                JOptionPane.showMessageDialog(this, "Checkout date must after checkin date");
                dcsExpectedCheckIn.setDate(null);
                dcsExpectedCheckOut.setDate(null);
                return;
            }
            if (txtExpectedRoom.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(this, "Please choose at least one room");
                return;
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int i = grViewReservation.getSelectedRow();
        if (i > -1) {
            if (JOptionPane.showConfirmDialog(null, "Are you sure to delete this reservation.", "Delete Confirm", JOptionPane.YES_NO_OPTION) == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Please choose a reservation to delete.");
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (btnStt) {
            if (i > -1) {
                ...
                JOptionPane.showMessageDialog(null, "Please chose a reservation.");
                return;
            }
            unlockBtn();
            btnResetActionPerformed(evt);
    ...
    private void btnCheckinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckinActionPerformed
        if (grViewReservation.getSelectedRow() != -1) {
            ...
            if (new Date().before(tmp.getExpectedCheckinDate())) {
                JOptionPane.showMessageDialog(this, "Can't check in this reservation.");
                return;
            }
            FSReceptionMenu recep = new FSReceptionMenu();
            recep.setLocationRelativeTo(this);
            recep.setVisible(true);
            FSCheckinList cl = new FSCheckinList();
            for (Reservation r : reList) {
                if (r.getReservationID() == Integer.parseInt(grViewReservation.getValueAt(grViewReservation.getSelectedRow(), 5).toString())) {
                    cl.setReser(r);
                }
            ...
            JOptionPane.showMessageDialog(this, "Please chose a reservation to check in.");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSReservationMenu().setVisible(true);
            }
        });
    }
