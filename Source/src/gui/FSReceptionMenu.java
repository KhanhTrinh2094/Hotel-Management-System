 ...
 * @author User
 */
public class FSReceptionMenu extends javax.swing.JFrame {

    /**
     * Creates new form Reservation
     */
    public static FSReceptionMenu it;
    String deputy, cusName;
    int roNo;
    String[] cus;

    public FSReceptionMenu() {
        initComponents();
        it = this;
        initData();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(0, 111));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/banner_Reception.png"))); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Reception Form", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jLabel1.setText("Deputy");

        txtCusGroup.setEditable(false);
        txtCusGroup.setPreferredSize(new java.awt.Dimension(297, 20));

        jLabel2.setForeground(new java.awt.Color(51, 51, 255));
        jLabel2.setText("Expected Check out Date");

        btnSelectCus.setText("Select Customers");
        ...
        btnSelectCusGroup.setText("Select Customer");
        ...
        GrViewReception.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Deputy", "Room", "Check in", "Expected check out", "id"
            }
        ) {
    ...
    private void btnSelectCusGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectCusGroupActionPerformed
        if (!btnSearch.isEnabled() && btnUpdate.isEnabled()) {
            if (GrViewReception.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please choose a reception before select customer.");
                return;
            }
        }
    ...
    private void btnSelectRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectRoomActionPerformed
        if (!btnSearch.isEnabled() && btnUpdate.isEnabled()) {
            if (GrViewReception.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please choose a reception before select room.");
                return;
            }
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (room.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Room must be number!");
            txtRoomS.requestFocus();
        } else {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (GrViewReception.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Please select a Reception to delete.");
            return;
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (btnStt) {
            if (GrViewReception.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(null, "Please select a Reception to update.");
                return;
            }
            if (txtCusGroup.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(null, "Please choose a deputy.");
                return;
            }
            if (txtaCustomers.getText().trim().length() == 0) {
                JOptionPane.showMessageDialog(null, "Please choose customers.");
                return;
            }
            ...
            if (dcsExpectedCheckOut.getDate() == null) {
                JOptionPane.showMessageDialog(this, "Please choose a valid expected check out date");
                dcsExpectedCheckOut.setDate(null);
                return;
            }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (btnStt) {
            ...
            btnStt = false;
            try {
                FSCheckinList.it.respon(getRoomNo(tempRecep.getRoomID()));
            } catch (Exception e) {
            }
        } else {
            tempRecep = new Reception();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSReceptionMenu().setVisible(true);
            }
        });
    }
