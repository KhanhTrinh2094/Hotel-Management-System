 ...
 * @author User
 */
public class FSServices extends javax.swing.JFrame {

    /**
     * Creates new form FSServices
     */
    public FSServices(String s) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Order Services", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));

        jScrollPane1.setViewportView(lstUser);

        jScrollPane2.setViewportView(lstMenu);

        cbbType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Service", "Food", "Drink" }));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if (lstUser.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Please choose service to delete");
            return;
        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (servicesOut.length==0 && foodsOut.length==0 && drinksOut.length==0) {
            JOptionPane.showMessageDialog(null, "Please choose services to order!");
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSServices().setVisible(true);
            }
        });
    }
