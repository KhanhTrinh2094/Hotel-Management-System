...
public class FSServiceMenu extends javax.swing.JFrame {
    ...
    public void refresh() {
        ...
        if (roomno.isEmpty() || roomno.length() > 5 || !Pattern.compile("^\\d+$").matcher(roomno).matches()) {
            JOptionPane.showMessageDialog(null, "Room number must be a digit( Max 5 digits ))!");
            txtRoom.setText("");
        ...
        if (flag == 0) {
            JOptionPane.showMessageDialog(null, "This room is still emply or has been paid!");
            txtRoom.setText("");
            txtRoom.requestFocusInWindow();
            id = 0;
            return;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/banner_Service.png"))); // NOI18N
        ...
        btnOrder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/btnOrder.png"))); // NOI18N
...
//        if (id != 0) {
//            FSServices sv = new FSServices(String.valueOf(id));
...
//        }
        ...
        if (ids.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please choose room to order!");
            txtRoom.requestFocusInWindow();
            return;
        }
        ...
        if (flag == 0) {
            JOptionPane.showMessageDialog(null, "This room is still emply!");
            txtRoom.setText("");
            txtRoom.requestFocusInWindow();
            id = 0;
            return;
        ...
        FSServices sv = new FSServices(ids);
        sv.setLocationRelativeTo(this);
        sv.setVisible(true);
