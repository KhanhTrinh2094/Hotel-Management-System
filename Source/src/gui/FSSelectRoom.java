 ...
 * @author User
 */
public class FSSelectRoom extends javax.swing.JFrame {
...
//        ((JSpinner.DefaultEditor) spRooms.getEditor()).getTextField().setEditable(false);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Selecting Room", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Customer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)), "Selected", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        if (grSelect.getRowCount() != 0) {
            if (form.equals("recep")) {
                if (from == 1) {
                    FSReceptionMenu.it.tempRecep.setRoomID((int) grSelect.getValueAt(0, 2));
                }
                FSReceptionMenu.it.tempRecep.setExpectedCheckoutDate(dcsTo.getDate());
                FSReceptionMenu.it.fillData(FSReceptionMenu.it.tempRecep);
                this.dispose();
            }
            if (form.equals("reser")) {
                if (from == 0) {
                    ...
                    FSReservationMenu.it.tempRe.setExpectedRoom(s);
                    FSReservationMenu.it.tempRe.setRoomTypeID(getRoomTypeID(String.valueOf(grSelect.getValueAt(0, 1))));
                }
                FSReservationMenu.it.tempRe.setExpectedCheckinDate(dcsFrom.getDate());
                FSReservationMenu.it.tempRe.setExpectedCheckoutDate(dcsTo.getDate());
                FSReservationMenu.it.fillData(FSReservationMenu.it.tempRe);
                this.dispose();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Can not submit when selected list is empty.");
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        roomx = new ArrayList<>();
        if (from == null) {
            JOptionPane.showMessageDialog(this, "Please choose a valid From date");
            dcsFrom.setDate(null);
            return;
        }
        if (to == null) {
            JOptionPane.showMessageDialog(this, "Please choose a valid To date");
            dcsTo.setDate(null);
            return;
        }
        if (from.before(new Date()) && form.equals("reser")) {
            JOptionPane.showMessageDialog(this, "From date must after today.");
            dcsFrom.setDate(null);
            return;
        }
        if (from.after(to)) {
            JOptionPane.showMessageDialog(this, "From date must before To date");
            dcsFrom.setDate(null);
            dcsTo.setDate(null);
            return;
        }
        ...
        if (no.trim().length() != 0) {
            if (!Pattern.compile("\\d+", Pattern.CASE_INSENSITIVE).matcher(no).matches()) {
                JOptionPane.showMessageDialog(null, "Room number must be number!");
        ...
        if (rs.getViewRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "No room to meet the requirement.");
        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (count < max) {
            if (grCus.getSelectedRow() == -1) {
                JOptionPane.showMessageDialog(this, "Please select a room before add.");
                return;
            }
            for (int i = 0; i < grSelect.getRowCount(); i++) {
                if (grCus.getValueAt(grCus.getSelectedRow(), 0) == grSelect.getValueAt(i, 0)) {
                    JOptionPane.showMessageDialog(this, "Cannot add this room.");
                    return;
                }
            }
            Vector v = new Vector();
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        if (grSelect.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Please select a room before remove.");
            return;
        }
        Vector v = new Vector();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSSelectRoom().setVisible(true);
            }
        });
    }
